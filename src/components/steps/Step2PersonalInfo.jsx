...
export default function Step2PersonalInfo({formState,onNext,onBack,isFirstStep,isLastStep}) {
  const {register,handleSubmit,formState:{errors}}=useForm({
    resolver:zodResolver(step2Schema),
    defaultValues:{fullName:formState.fullName,dob:formState.dob,gender:formState.gender,maritalStatus:formState.maritalStatus,fatherName:formState.fatherName,motherName:formState.motherName,email:formState.email,mobile:formState.mobile,alternateMobile:formState.alternateMobile}
  });
