...
const labels={
  panCard:'PAN card',aadhaarFront:'Aadhaar front',aadhaarBack:'Aadhaar back',bankStatements:'Bank statements',
  photograph:'Photograph',salarySlips:'Salary slips',itr:'ITR documents',propertyDocuments:'Property documents',
  businessRegistration:'Business registration',gstReturns:'GST returns'
};

export default function Step7Documents({formState,onNext,onBack,isFirstStep,isLastStep}) {
