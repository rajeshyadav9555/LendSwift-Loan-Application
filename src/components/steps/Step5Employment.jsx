...
export default function Step5Employment({formState,onNext,onBack,isFirstStep,isLastStep}) {
  ...
  return <form onSubmit={handleSubmit(onNext)} noValidate>
    ...
    {type==='salaried' && <div className="space-y-4">
