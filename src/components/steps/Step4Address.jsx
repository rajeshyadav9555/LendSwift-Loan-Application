...
export default function Step4Address({formState,onNext,onBack,isFirstStep,isLastStep}) {
  const {register,control,handleSubmit,watch,setValue,formState:{errors}}=useForm({
    resolver:zodResolver(step4Schema),
    defaultValues:{addressLine1:formState.addressLine1,addressLine2:formState.addressLine2,pincode:formState.pincode,city:formState.city,state:formState.state,residenceType:formState.residenceType,rentAmount:formState.rentAmount,yearsAtAddress:formState.yearsAtAddress,sameAsPermanent:formState.sameAsPermanent,permanentAddressLine1:formState.permanentAddressLine1,permanentPincode:formState.permanentPincode,permanentCity:formState.permanentCity,permanentState:formState.permanentState}
  });
  const pincode=watch('pincode'), same=watch('sameAsPermanent'), residence=watch('residenceType');
  ...
  return <form onSubmit={handleSubmit(onNext)} noValidate>
    ...
    <div className="space-y-4">
      ...
      {!same && <div className="border-t pt-4 space-y-4">
