...
const initialState = {
  loanType: '', loanAmount: 500000, loanTenure: 24, loanPurpose: '', referralCode: '',
  fullName: '', dob: '', gender: '', maritalStatus: '', fatherName: '', motherName: '',
  email: '', mobile: '', alternateMobile: '', pan: '', panVerified: false, aadhaar: '',
  aadhaarConsent: false, voterId: '', passport: '', addressLine1: '', addressLine2: '',
  pincode: '', city: '', state: '', residenceType: '', rentAmount: 0, yearsAtAddress: 0,
  sameAsPermanent: true, permanentAddressLine1: '', permanentPincode: '', permanentCity: '',
  permanentState: '', employmentType: '', employerName: '', designation: '', monthlyIncome: 0,
  yearsExperience: 0, businessName: '', businessType: '', annualTurnover: 0, yearsInBusiness: 0,
  gstNumber: '', officeAddress: '', coApplicantRequired: false, coApplicantName: '',
  relationship: '', coApplicantPan: '', coApplicantIncome: 0, coApplicantConsent: false,
  documents: {}, signature: null, currentStep: 1
};
